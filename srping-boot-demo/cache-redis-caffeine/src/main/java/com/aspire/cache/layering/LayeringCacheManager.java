...
public class LayeringCacheManager implements CacheManager {
     ...
     * 设置是否允许Cache的值为null
     *
     * @param allowNullValues true|false
     */
    ...
    public boolean getUsedFirstCache(String name) {
        ...
        return secondaryCacheSetting == null || secondaryCacheSetting.getUsedFirstCache();
    }
    ...
    public boolean getForceRefresh(String name) {
        ...
        return secondaryCacheSetting != null && secondaryCacheSetting.getForceRefresh();
    }
