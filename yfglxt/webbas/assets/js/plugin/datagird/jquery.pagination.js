...
//默认只是刷新，增加取第几页功能，可以跳转到页面输入的页数   by haomingli
var _9=parseInt($('.pagination-num',this).val())||1;
var _2f=$(this).pagination("options");
if(_2f.onBeforeRefresh.call(this,_9,_2f.pageSize)!=false){
$(this).pagination("select",_9);
_2f.onRefresh.call(this,_9,_2f.pageSize);
}
}}}};
})(jQuery);
