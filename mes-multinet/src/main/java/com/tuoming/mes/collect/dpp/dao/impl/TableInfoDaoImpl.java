...
public class TableInfoDaoImpl extends AbstractBaseDao<TableInfo, String> implements TableInfoDao {

    private static Logger logger = LogFacade.getLog4j(TableInfoDaoImpl.class);
