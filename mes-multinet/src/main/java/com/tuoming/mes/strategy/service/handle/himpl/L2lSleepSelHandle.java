    ...
    public String handle(List<Map<String, Object>> dataList,
        ...
        try {
            ...
            for (Map<String, Object> data : dataList) {
                ...
                if (src_sxsjl < thresholdDic.get("L2L_SXSJLL_SLEEP")
                        && src_xxsjl < thresholdDic.get("L2L_XXSJLL_SLEEP")
                        && src_prblyl < thresholdDic.get("L2L_PRBLYL_SLEEP")
                        && src_zdyhs < thresholdDic.get("L2L_ZDYHS_SLEEP")) {
                    String makeUpArea = String.valueOf(data.get("dest_enodebid"))
                            + "_" + String.valueOf(data.get("dest_cellid"));//补偿小区标识
                    ...
                    if (sxsjll_lj < thresholdDic.get("L2L_SXSJLL_MAKEUP")
                            && xxsjll_lj < thresholdDic.get("L2L_XXSJLL_MAKEUP")
                            && zdyhs_lj < thresholdDic.get("L2L_ZDYHS_MAKEUP")) {
